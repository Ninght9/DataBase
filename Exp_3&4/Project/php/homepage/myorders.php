...
$sql = "select canteen_cuisine.canteen_id,cuisine_name,amount from orders,canteen_cuisine,cuisine where
        orders.user_id=$user_id and
        orders.canteen_id=canteen_cuisine.canteen_id and
        orders.cuisine_id=canteen_cuisine.cuisine_id and
        cuisine.cuisine_id=canteen_cuisine.cuisine_id";
$result = $conn->query($sql);
$num = mysqli_num_rows($result);
$file = '../../tempfiles/myorders.json';
unlink($file);
